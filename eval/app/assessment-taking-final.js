(function(){if(!window.EXAI_ATTEMPT_UI){const script=document.createElement('script');script.src=(location.pathname.includes('/eval/')?'/eval/app/attempt-adapter-bridge.js':'app/attempt-adapter-bridge.js')+'?v=20260912-4';document.head.append(script)}})();
