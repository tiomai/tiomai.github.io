window.addEventListener('DOMContentLoaded',()=>{
  ...
  if(nav&&!nav.querySelector('[href*="performance-v2"]'))nav.insertAdjacentHTML('beforeend','<a class="nav-link" href="performance/"><span style="font-size:20px">↗</span>Performance</a>');
});
