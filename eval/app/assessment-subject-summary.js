window.addEventListener('DOMContentLoaded',()=>{
  ...
  if(nav&&!nav.querySelector('[href*="performance-v2"]'))nav.insertAdjacentHTML('beforeend','<a class="nav-link" href="performance/"><svg class="performance-nav-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 17l5-5 4 4 7-9"/><path d="M14 7h5v5"/></svg>Performance</a>');
});
