window.addEventListener('DOMContentLoaded',async()=>{
  ...
  const destinationFor=async user=>{
    ...
    if(!window.EXAI_CONTEXT_READY){const script=document.createElement('script');script.src=location.pathname.includes('/eval/')?'/eval/app/context-bootstrap.js?v=20260904-1':'app/context-bootstrap.js?v=20260904-1';document.head.append(script);await new Promise((resolve,reject)=>{script.onload=resolve;script.onerror=reject})}
