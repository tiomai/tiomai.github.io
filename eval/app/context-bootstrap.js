(function(){
  ...
  window.EXAI_CONTEXT_READY=(async()=>{await load('ui-copy-policy.js?v=20260918-1');if(!window.supabase)await load('supabase.js');if(!window.EXAI_SUPABASE_CONFIG)await load('supabase-config.js');if(!window.EXAI_ADAPTERS)await load('frontend-adapters.js?v=20260918-2');if(!window.EXAI_ACCOUNT_CONTEXT)await load('account-context.js?v=20260918-2');if(!window.EXAI_DEMO_TEACHER_VIEW_MODEL)await load('demo-teacher-view-model.js?v=20260918-2');if(!window.EXAI_PERFORMANCE_TEACHER_RENDERERS)await load('performance-teacher-renderers.js?v=20260918-7');if(!window.EXAI_SCREEN_BINDINGS)await load('screen-data-bindings.js?v=20260914-1');if(!window.EXAI_LEARNING_RESET_ACTIONS)await load('learning-reset-actions.js');if(!window.EXAI_STUDENT_ENTRY_FIXES)await load('student-entry-fixes.js');if(!window.EXAI_PRACTICE_LAUNCH_METADATA)await load('practice-launch-metadata.js');await load('performance-insight-copy.js');return window.EXAI_ACCOUNT_CONTEXT})();
})();
